...
const data = ref<DataRow[]>([
  { id: 1, city: '杭州市萧山区', facilityName: '杭金衢高速K12', deviceName: '杭金衢高速路面沉降设备', monitorItem: '路面沉降', pointName: 'K12+500路面沉降监测点', alertStartTime: '2026-06-05 08:30:00', alertEndTime: '2026-06-05 14:20:00', alertValue: '-1.50', alertLevel: '一级预警', handleTime: '2026-06-06 10:00:00', handler: '张伟', handleStatus: '已完成' },
  { id: 2, city: '宁波市鄞州区', facilityName: '甬台温高速K88', deviceName: '甬台温高速边坡监测设备', monitorItem: '边坡倾斜', pointName: 'K88+200边坡倾斜监测点', alertStartTime: '2026-06-08 16:45:00', alertEndTime: '', alertValue: '0.15', alertLevel: '二级预警', handleTime: '', handler: '', handleStatus: '未完成' },
])

  ...
  <div class="personnel-page">
    <div class="search-bar">
      <a-row :gutter="16" align="middle">
        <a-col><span class="search-label">所属检测单位：</span><a-input v-model:value="searchForm.unitName" placeholder="请输入" style="width: 150px" /></a-col>
...
const jobTypeOptions = ['检测人', '负责人']

const columns = [
  { title: '序号', key: 'index', width: 60 },
  { title: '所属检测单位', dataIndex: 'unitName', key: 'unitName', width: 160 },
...
const tableData = ref<PersonnelRow[]>([
  { id: 1, unitName: '浙江省交通检测中心', creditCode: '91330000MA1H0001X1', region: '杭州市西湖区', name: '王建明', idCard: '330106198805123018', phone: '13811001001', gender: '男', education: '本科', role: '审核人员', jobType: '检测人', status: '启用' },
  { id: 2, unitName: '宁波市桥梁检测中心', creditCode: '91330200MA2K0002X2', region: '宁波市鄞州区', name: '刘晓燕', idCard: '330212199208145027', phone: '13822002002', gender: '女', education: '硕士', role: '操作人员', jobType: '检测人', status: '启用' },
  { id: 3, unitName: '温州市隧道检测所', creditCode: '91330300MA2L0003X3', region: '温州市鹿城区', name: '陈国栋', idCard: '330302198603221015', phone: '13833003003', gender: '男', education: '本科', role: '操作人员、审核人员', jobType: '负责人', status: '启用' },
])
...
const modalTitle = computed(() => {
  if (formMode.value === 'add') return '新增检测单位从业人员'
  if (formMode.value === 'view') return '查看检测单位从业人员'
  return '编辑检测单位从业人员'
})

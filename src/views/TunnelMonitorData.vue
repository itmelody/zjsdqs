...
const data = ref<DataRow[]>([
  { id: 1, city: '杭州市西湖区', facilityName: '紫之隧道', deviceName: '紫之隧道结构变形设备', monitorItem: '结构变形', pointName: 'K3+200拱顶沉降监测点', monitorTime: today, dailyMax: '1.50', dailyMin: '0.95', dailyAvg: '1.25', latestTime: `${todayShort} 11:20:00`, latestValue: '1.25' },
  { id: 2, city: '宁波市鄞州区', facilityName: '常洪隧道', deviceName: '常洪隧道渗漏监测设备', monitorItem: '渗漏水压', pointName: 'K1+800渗漏监测点', monitorTime: today, dailyMax: '0.12', dailyMin: '0.05', dailyAvg: '0.08', latestTime: `${todayShort} 15:40:00`, latestValue: '0.08' },
  { id: 3, city: '台州市临海市', facilityName: '括苍山隧道', deviceName: '括苍山隧道通风设备', monitorItem: '通风监测', pointName: 'K5+100通风监测点', monitorTime: d3, dailyMax: '4.2', dailyMin: '2.8', dailyAvg: '3.5', latestTime: `${d3s} 08:30:00`, latestValue: '3.5' },
])

...
const districtOptions = computed(() => form.value.city ? cityDistrictMap[form.value.city] || [] : [])
function onCityChange() { form.value.district = undefined }
...
const deviceData = ref<DeviceRow[]>([
  { id: 1, facilityId: 'R001', facilityName: '杭金衢高速K12', deviceId: 'R00001', deviceName: '杭金衢高速路面沉降设备', deviceType: '沉降仪', monitorItem: '路面沉降', pointName: 'K12+500路面沉降监测点', region: '杭州市萧山区', online: '在线', latestTime: `${today} 10:30:00`, latestValue: '-0.85' },
  { id: 2, facilityId: 'R002', facilityName: '甬台温高速K88', deviceId: 'R00002', deviceName: '甬台温高速边坡监测设备', deviceType: '倾斜仪', monitorItem: '边坡倾斜', pointName: 'K88+200边坡倾斜监测点', region: '宁波市鄞州区', online: '在线', latestTime: `${today} 14:15:00`, latestValue: '0.02' },
  { id: 3, facilityId: 'R003', facilityName: '杭甬高速K45', deviceId: 'R00003', deviceName: '杭甬高速路基振动设备', deviceType: '加速度计', monitorItem: '路基振动', pointName: 'K45+800路基振动监测点', region: '绍兴市越城区', online: '离线', latestTime: `${d3} 09:20:00`, latestValue: '0.0015' },
])

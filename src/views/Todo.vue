      ...
      <a-tabs v-model:activeKey="riskTab" class="risk-tabs">
        <a-tab-pane key="hazard" tab="隐患排查">
          ...
          <div class="filter-bar">
            <a-select v-model:value="hazardFilters.city" placeholder="地市" allow-clear style="width: 120px">
        ...
        <a-tab-pane key="facility" tab="设施检测">
          <!-- 筛选项 -->
          <div class="filter-bar">
            <a-select v-model:value="facilityFilters.city" placeholder="地市" allow-clear style="width: 120px">
              <a-select-option v-for="c in cityOptions" :key="c" :value="c">{{ c }}</a-select-option>
            </a-select>
        ...
        <a-row :gutter="16">
          <a-col :span="12">
            <a-form-item label="检测名称">
              <a-input v-model:value="editFacilityForm.name" placeholder="请输入检测名称" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="所属区域">
              <a-input v-model:value="editFacilityForm.region" placeholder="请输入所属区域" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="检测周期">
              <a-select v-model:value="editFacilityForm.cycle" placeholder="请选择">
          ...
          <a-col :span="12">
            <a-form-item label="检测单位">
              <a-input v-model:value="editFacilityForm.unit" placeholder="请输入检测单位" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item :label="editFacilityForm.facilityType === '道路' ? '道路名称' : editFacilityForm.facilityType === '桥梁' ? '桥梁名称' : '隧道名称'">
              <a-input v-model:value="editFacilityForm.facilityName" placeholder="请输入设施名称" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="检测时间">
              <a-date-picker v-model:value="editFacilityForm.detectTime" style="width: 100%" placeholder="请选择检测时间" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="负责人">
              <a-input v-model:value="editFacilityForm.manager" placeholder="请输入负责人" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item :label="`${editFacilityForm.facilityType}综合评价等级`">
              <a-select v-model:value="editFacilityForm.evaluationGrade" placeholder="请选择等级">
          ...
          <a-col :span="12">
            <a-form-item label="定期检测报告">
              <a-input v-model:value="editFacilityForm.report" placeholder="请输入检测报告名称" />
            </a-form-item>
          </a-col>
        </a-row>
...
// 地市选项
const cityOptions = ['杭州市', '宁波市', '温州市', '绍兴市', '湖州市', '嘉兴市', '金华市', '衢州市', '台州市', '丽水市', '舟山市']
...
const hazardFilters = ref({ city: undefined as string | undefined, taskName: '', category: undefined as string | undefined, facilityName: '' })

function resetHazardFilters() {
  hazardFilters.value = { city: undefined, taskName: '', category: undefined, facilityName: '' }
}
...
const hazardData = ref<HazardRow[]>([
  { id: 1, city: '杭州市', reportTime: '2026-05-20 09:30', taskName: '2026年杭州市日常隐患排查', category: '日常隐患排查', specialCategory: '', scene: '道路检查', facilityName: '杭州市西湖区文三路路段', address: '浙江省杭州市西湖区文三路268号', inspector: '张三', reportContent: '路面出现多处裂缝，长度约15米，宽度约2cm，存在安全隐患', reportImages: ['裂缝照片1.jpg', '裂缝照片2.jpg'], hazardLevel: '较大隐患', fixDeadline: '2026-06-05', fixCompleteTime: '2026-06-03', fixSubmitter: '李四', fixContent: '已完成裂缝灌缝处理，共修复15米裂缝', fixImages: ['修复后照片.jpg'], status: '已整改', overdue: '否', supervised: '否' },
  { id: 2, city: '宁波市', reportTime: '2026-05-27 14:15', taskName: '2026年宁波市专项隐患排查', category: '专项隐患排查', specialCategory: '季节性隐患排查', scene: '桥梁检查', facilityName: '宁波市鄞州区甬江大桥', address: '浙江省宁波市鄞州区甬江大道188号', inspector: '王五', reportContent: '桥梁伸缩缝处出现渗水现象，下部结构有水渍', reportImages: ['渗水照片.jpg'], hazardLevel: '重大隐患', fixDeadline: '2026-06-01', fixCompleteTime: '', fixSubmitter: '', fixContent: '', fixImages: [], status: '待整改', overdue: '是', supervised: '是' },
  { id: 3, city: '温州市', reportTime: '2026-06-01 10:45', taskName: '2026年温州市综合性安全隐患排查', category: '综合性安全隐患排查', specialCategory: '', scene: '隧道检查', facilityName: '温州市鹿城区大罗山隧道', address: '浙江省温州市鹿城区大罗山隧道入口', inspector: '赵六', reportContent: '隧道内照明灯具损坏3处，能见度不足', reportImages: ['照明损坏照片.jpg'], hazardLevel: '一般隐患', fixDeadline: '2026-06-15', fixCompleteTime: '', fixSubmitter: '', fixContent: '', fixImages: [], status: '待整改', overdue: '否', supervised: '否' },
  { id: 4, city: '绍兴市', reportTime: '2026-06-02 08:20', taskName: '2026年绍兴市专项隐患排查', category: '专项隐患排查', specialCategory: '重大活动/重大节日保障隐患排查', scene: '道路检查', facilityName: '绍兴市越城区解放路主干道', address: '浙江省绍兴市越城区解放路100号', inspector: '钱七', reportContent: '道路标线磨损严重，部分路段已无法辨识', reportImages: ['标线磨损照片.jpg'], hazardLevel: '较大隐患', fixDeadline: '2026-06-20', fixCompleteTime: '2026-06-18', fixSubmitter: '孙八', fixContent: '已重新施划道路标线，共修复200米', fixImages: ['修复后标线.jpg'], status: '已整改', overdue: '否', supervised: '否' },
  { id: 5, city: '湖州市', reportTime: '2026-06-03 16:30', taskName: '2026年湖州市日常隐患排查', category: '日常隐患排查', specialCategory: '', scene: '桥梁检查', facilityName: '湖州市吴兴区苕溪桥', address: '浙江省湖州市吴兴区苕溪路55号', inspector: '周九', reportContent: '桥面护栏有2处松动，存在行人安全风险', reportImages: ['护栏松动照片.jpg'], hazardLevel: '一般隐患', fixDeadline: '2026-06-10', fixCompleteTime: '', fixSubmitter: '', fixContent: '', fixImages: [], status: '待整改', overdue: '否', supervised: '否' },
  { id: 6, city: '嘉兴市', reportTime: '2026-04-15 11:00', taskName: '2026年嘉兴市专项隐患排查', category: '专项隐患排查', specialCategory: '专业隐患排查', scene: '隧道检查', facilityName: '嘉兴市南湖区南湖隧道', address: '浙江省嘉兴市南湖区南湖大道隧道段', inspector: '吴十', reportContent: '隧道内壁出现渗水裂缝，长约3米', reportImages: ['渗水裂缝.jpg'], hazardLevel: '重大隐患', fixDeadline: '2026-05-15', fixCompleteTime: '', fixSubmitter: '', fixContent: '', fixImages: [], status: '待整改', overdue: '是', supervised: '是' },
])

const filteredHazardData = computed(() => {
  return hazardData.value.filter(row => {
    if (hazardFilters.value.city && !row.facilityName.includes(hazardFilters.value.city)) return false
...
const facilityFilters = ref({ city: undefined as string | undefined, name: '', facilityType: undefined as string | undefined, facilityName: '' })

function resetFacilityFilters() {
  facilityFilters.value = { city: undefined, name: '', facilityType: undefined, facilityName: '' }
}
...
const facilityColumns = [
  ...
  { title: '检测类型', dataIndex: 'detectType', key: 'detectType', width: 80 },
  { title: '综合评价等级', dataIndex: 'evaluationGrade', key: 'evaluationGrade', width: 110 },
  { title: '整改类型', dataIndex: 'fixType', key: 'fixType', width: 110 },
  { title: '整改完成状态', dataIndex: 'fixStatus', key: 'fixStatus', width: 100 },
...
const facilityData = ref<FacilityRow[]>([
  { id: 1, city: '杭州市', name: '2026年杭州市道路常规检测', facilityType: '道路', facilityName: '杭州市西湖区文三路路段', detectTime: '2026-05-06', detectType: '常规检测', evaluationGrade: 'B', fixType: '维修整治', fixStatus: '已完成', fixCancelDate: '2026-06-01', fixAfterGrade: 'A', region: '杭州市西湖区', cycle: '一年', unit: '浙江省交通检测中心', manager: '张三', report: '文三路检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 2, city: '宁波市', name: '2026年宁波市桥梁常规检测', facilityType: '桥梁', facilityName: '宁波市鄞州区甬江大桥', detectTime: '2026-04-20', detectType: '常规检测', evaluationGrade: 'C', fixType: '维修整治', fixStatus: '未完成', fixCancelDate: '', fixAfterGrade: '', region: '宁波市鄞州区', cycle: '一年', unit: '宁波市桥梁检测中心', manager: '李四', report: '甬江大桥检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 3, city: '温州市', name: '2026年温州市隧道常规检测', facilityType: '隧道', facilityName: '温州市鹿城区大罗山隧道', detectTime: '2026-05-15', detectType: '常规检测', evaluationGrade: 'D', fixType: '', fixStatus: '未完成', fixCancelDate: '', fixAfterGrade: '', region: '温州市鹿城区', cycle: '一年', unit: '浙江省隧道检测所', manager: '王五', report: '大罗山隧道检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 4, city: '绍兴市', name: '2026年绍兴市道路常规检测', facilityType: '道路', facilityName: '绍兴市越城区解放路', detectTime: '2026-03-28', detectType: '常规检测', evaluationGrade: 'C', fixType: '维修整治', fixStatus: '已完成', fixCancelDate: '2026-05-10', fixAfterGrade: 'B', region: '绍兴市越城区', cycle: '半年', unit: '绍兴市道路检测站', manager: '钱七', report: '解放路检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 5, city: '湖州市', name: '2026年湖州市桥梁常规检测', facilityType: '桥梁', facilityName: '湖州市吴兴区苕溪桥', detectTime: '2026-05-22', detectType: '常规检测', evaluationGrade: '不合格', fixType: '', fixStatus: '未完成', fixCancelDate: '', fixAfterGrade: '', region: '湖州市吴兴区', cycle: '一年', unit: '湖州市桥梁检测中心', manager: '周九', report: '苕溪桥检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 6, city: '嘉兴市', name: '2026年嘉兴市隧道常规检测', facilityType: '隧道', facilityName: '嘉兴市南湖区南湖隧道', detectTime: '2026-04-10', detectType: '常规检测', evaluationGrade: 'E', fixType: '维修整治', fixStatus: '已完成', fixCancelDate: '2026-05-20', fixAfterGrade: 'C', region: '嘉兴市南湖区', cycle: '一年', unit: '浙江省交通检测中心', manager: '吴十', report: '南湖隧道检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 7, city: '金华市', name: '2026年金华市道路常规检测', facilityType: '道路', facilityName: '金华市婺城区宾虹路', detectTime: '2026-04-18', detectType: '常规检测', evaluationGrade: 'D', fixType: '', fixStatus: '未完成', fixCancelDate: '', fixAfterGrade: '', region: '金华市婺城区', cycle: '一年', unit: '金华市道路检测站', manager: '孙八', report: '宾虹路检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 8, city: '衢州市', name: '2026年衢州市桥梁常规检测', facilityType: '桥梁', facilityName: '衢州市柯城区西安门大桥', detectTime: '2026-05-08', detectType: '常规检测', evaluationGrade: 'D', fixType: '维修整治', fixStatus: '已完成', fixCancelDate: '2026-06-05', fixAfterGrade: 'B', region: '衢州市柯城区', cycle: '一年', unit: '衢州市桥梁检测中心', manager: '赵六', report: '西安门大桥检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 9, city: '台州市', name: '2026年台州市隧道常规检测', facilityType: '隧道', facilityName: '台州市黄岩区方山隧道', detectTime: '2026-03-22', detectType: '常规检测', evaluationGrade: 'D', fixType: '拆除或完全封控', fixStatus: '已完成', fixCancelDate: '2026-04-30', fixAfterGrade: 'B', region: '台州市黄岩区', cycle: '一年', unit: '浙江省隧道检测所', manager: '吴十', report: '方山隧道检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 10, city: '丽水市', name: '2026年丽水市桥梁常规检测', facilityType: '桥梁', facilityName: '丽水市莲都区小水门大桥', detectTime: '2026-05-30', detectType: '常规检测', evaluationGrade: 'E', fixType: '', fixStatus: '未完成', fixCancelDate: '', fixAfterGrade: '', region: '丽水市莲都区', cycle: '一年', unit: '丽水市桥梁检测中心', manager: '钱七', report: '小水门大桥检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 11, city: '台州市', name: '2026年台州市道路常规检测', facilityType: '道路', facilityName: '台州市椒江区中山东路', detectTime: '2026-04-05', detectType: '常规检测', evaluationGrade: 'D', fixType: '维修整治', fixStatus: '已完成', fixCancelDate: '2026-05-15', fixAfterGrade: 'B', region: '台州市椒江区', cycle: '一年', unit: '台州市道路检测站', manager: '孙八', report: '中山东路检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
  { id: 12, city: '舟山市', name: '2026年舟山市隧道常规检测', facilityType: '隧道', facilityName: '舟山市定海区东港隧道', detectTime: '2026-05-12', detectType: '常规检测', evaluationGrade: 'E', fixType: '', fixStatus: '未完成', fixCancelDate: '', fixAfterGrade: '', region: '舟山市定海区', cycle: '一年', unit: '浙江省隧道检测所', manager: '周九', report: '东港隧道检测报告', mainProblem: '', problemTime: '', planTime: '', measures: '', nextFix: '' },
])
...
const filteredFacilityData = computed(() => {
  return facilityData.value.filter(row => {
    ...
    if (facilityFilters.value.city && row.city !== facilityFilters.value.city) return false
...
const editFacilityForm = ref({
  ...
  fixType: undefined as string | undefined, fixStatus: undefined as string | undefined, fixCancelDate: null as any, fixAfterGrade: undefined as string | undefined,
})
...
function openEditFacilityModal(record: FacilityRow) {
  ...
  editFacilityForm.value = {
    ...
    detectTime: record.detectTime as any, manager: record.manager, evaluationGrade: record.evaluationGrade,
    report: record.report, mainProblem: record.mainProblem, problemTime: record.problemTime as any,
    planTime: record.planTime as any, measures: record.measures, nextFix: record.nextFix,
    fixType: record.fixType || undefined, fixStatus: record.fixStatus || undefined,
    fixCancelDate: record.fixCancelDate as any, fixAfterGrade: record.fixAfterGrade || undefined,
  }
...
function submitEditFacility() {
  ...
  row.fixCancelDate = editFacilityForm.value.fixCancelDate || ''
